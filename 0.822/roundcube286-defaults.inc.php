...
// inkVerb tried changing this to 'db' from the default 'null', but decided not to.
...
// added by inkVerb in the event that Roundcube's roadmap ever fully integrates RFC 6154 tags
//$config['all_mbox'] = 'All';
//$config['flagged_mbox'] = 'Flagged';
